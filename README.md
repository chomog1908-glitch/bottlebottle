...
| 레벨 | 규칙 | 무엇이 달라지나 |
|--:|:--|:--|
| `701–850` | 📏 가로±3 세로±3 | 멀리 있는 병엔 못 붓는다 |
| `851–1000` | 📏 가로±2 세로±2 | 더 좁아진다 |
| `1001–1150` | 📏 가로±3 **세로±1** | 위아래로만 조인다 |
| `1151–1300` | 📏 가로±1 세로±1 | 바로 옆 병만 |
...
>
> 📐 **이웃 제한 구간에서는 판을 줄이지 않는다.** 이 규칙의 손잡이는 병 수도 깊이도 아닌
> **격자의 한 줄 병 수**였기 때문. 실측 근거는 아래 함정 목록에 있다.
>
...
5단계  아이콘 · 이름 · 스플래시   ████████░░░░░░░░░░░░  🚧 진행 중
6단계  어머니 피드백 반영         ░░░░░░░░░░░░░░░░░░░░  ⏳ 예정
```

**5단계에 남은 것** — 앱 아이콘, 앱 이름, 스플래시 화면, 설치 안내문.
서명 APK 빌드와 실기기 설치는 끝났다. **BGM은 넣지 않는다** — 오래 하면 피로하다.
